 ...
 */
public final class RustAnalyserOptionsImpl {

    private static final String RUST_ANALYZER_LOCATION_KEY = "rust-analyzer-location"; // NOI18N

    private static Preferences getPreferences() {
        return NbPreferences.forModule(RustAnalyserOptionsImpl.class);
    }
     ...
     */
    public static Path getRustAnalyzerLocation(boolean verifying) {
        ...
        if (rustAnalyzer != null && verifying) {
