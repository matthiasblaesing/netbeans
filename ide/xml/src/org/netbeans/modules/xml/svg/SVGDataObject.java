...
@DataObject.Registration(
        mimeType = SVGDataObject.MIME_SVG,
        iconBase = "org/netbeans/modules/xml/resources/xmlObject.gif",
        displayName = "Smth",
        position = 300
)
public final class SVGDataObject extends XMLDataObject {
 ...
 */
     ...
     *
     */
    public static class SVGDataNode extends DataNode {

        /** Create new SVGDataNode. */
        public SVGDataNode (SVGDataObject obj) {
            super (obj, Children.LEAF);
            setIconBaseWithExtension ("org/netbeans/modules/xml/resources/xmlObject.gif"); // NOI18N
//            setShortDescription (Util.THIS.getString (XMLDataObject.class, "PROP_SVGDataNode_description"));
            setShortDescription("It is an SVG");
        }

    } // end of class SVGDataNode
...
//                return new ViewSupport (SVGDataObject.this.getPrimaryEntry());
//            } else {
//                return null;
//            }
//        }
